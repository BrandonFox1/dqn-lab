...
let ui = src('src/ui.js')
  ...
  .replace("'__ARCADE_B64__'", () => JSON.stringify(src('brains/arcade.b64').trim()))
  .replace('__ARCADE_META__', () => src('brains/arcade.json').trim())
  .replace('__ARCADE_CURVE__', () => src('brains/arcade_curve.json').trim());
...
const out = src('src/index.html')
  ...
  .replace('/*__ARCADE__*/', () => src('../arcade/arcade.js'))
  .replace('/*__UI__*/', () => ui);
