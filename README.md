...
| [`workshop/`](workshop/) | **The DQN Workshop**: a single HTML page with three interactive stations (the Bench, Ripple Tank, Arcade) and a hand-written JavaScript neural network. Live at https://brandonfox1.github.io/dqn-lab/ (auto-published from `main`) and https://claude.ai/artifact/83NAYFuuY2pjCfeYbm4UG4 |
