...
- Four ghosts brain (from pacdqn/): `python -m pacdqn.arcade_train train --out runs/arcade --steps 30000000` · `... exam --run runs/arcade --games 50` · `... export --run runs/arcade_ft/combined --ckpt final.pt --dest ../workshop/brains/arcade` (the shipped brain; then `npm run build` in workshop/)
